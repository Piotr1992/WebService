    ...
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int logJsonCfg = ConfigurationManager.AppSettings["logJson"] != null ? Convert.ToInt32(ConfigurationManager.AppSettings["logJson"]) : 0;
                LogUsage.Params = logParamsCfg == 2 ? true : (logParamsCfg == 1 && Logger.IsDebugEnabled ? true : false);
                LogUsage.Json = logJsonCfg == 1 ? true : false;
                watch.Stop();
